    ...
    <asp:ListView runat="server" ID="ListViewArticles" 
        ...
        <LayoutTemplate>
            <div class="row">
                ...
                <asp:LinkButton runat="server" ID="ButtonSortByCategory" CssClass="col-md-2 btn btn-default" Text="Sort by Category"/>
                <asp:LinkButton runat="server" ID="ButtonSortByLikes" CssClass="col-md-2 btn btn-default" Text="Sort by Likes" />
            </div>
        ...
        <InsertItemTemplate>
            ...
            <div id="panelInsertArticle" style="display: none;">
                ...
                <div class="row">
                    ...
                    <p>
                        Category: 
                    <asp:DropDownList runat="server" ID="DropDownListCategories" ItemType="NewsSystem.Models.Category" 
                        DataTextField="Name" SelectedValue="<%#: BindItem.CategoryId %>" 
                        DataValueField="Id" SelectMethod="DropDownListCategories_GetData">
                    </asp:DropDownList>
                    </p>
                    <p>
                        Content: 
